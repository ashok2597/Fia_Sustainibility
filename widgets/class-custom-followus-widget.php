...
add_action( 'widgets_init', 'fia_followus_widget' );

/**
 * Register the Follow Us Widget
 */
function fia_followus_widget() {
...
class Followus extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
                'followus', // Base ID
                __( 'Fia - Follow Us', 'fia' ), // Name
                array('description' => __( 'Custom follow us widget', 'fia' )) // Args
        );
    }
...
<?php
    ...
    ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'fia' ); ?></label> 
