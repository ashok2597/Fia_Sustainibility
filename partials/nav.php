          ...
          <div class="menubar custom-menu-primary">
            ...
            <div class="menuParent">
              <div class="navbar noListStyle">
                ...
                ?>
                  <li class="childmenu Megachildmenu">
                    <a href="<?php echo $gen_menu_page['url'] ?>" class="<?php echo ($row_index == 0) ? 'active' : ''; ?>">
                      <?php echo $gen_menu_page['title']; ?>
                      <span class="downAngle">
...
<?php if (is_page_template('templates/offsetting-template.php')||is_page_template('templates/article.php')) {	?>
