<?php if (have_rows('rc_emission')) : ?>
    ...
    ?>
        <div class="ContentGrpTitleTop  marginRight pt25">
            <div class="ContentGrpTitle" data-aos="fade-up">
                <h5><?php echo $subheading; ?></h5>
            </div>
            <div class="ContentGrpTop " data-aos="fade-up">
                <?php echo $subcontent; ?>
            </div>
        </div>
    <?php endwhile; ?>
...
<?php if (have_rows('reduce_polution_list')) : ?>
    <div class="ContentGrpListItem ContentGrpListItemV2 listStyleDoubleAngle   marginRight pt30">
        <ul>
