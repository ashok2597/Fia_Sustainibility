 ...
 */
function fia_custom_colors_css() {
	...
	/**
	 * Filter Fia default saturation level.
	 *
	 * @since Fia 1.0
	 *
	...
	$saturation           = absint( apply_filters( 'fia_custom_colors_saturation', 100 ) );
	$saturation           = $saturation . '%';

	$saturation_selection = absint( apply_filters( 'fia_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	$lightness            = absint( apply_filters( 'fia_custom_colors_lightness', 33 ) );
	$lightness            = $lightness . '%';

	$lightness_hover      = absint( apply_filters( 'fia_custom_colors_lightness_hover', 23 ) );
	$lightness_hover      = $lightness_hover . '%';

	$lightness_selection  = absint( apply_filters( 'fia_custom_colors_lightness_selection', 90 ) );
	 ...
	 */
	return apply_filters( 'fia_custom_colors_css', $css, $primary_color, $saturation );
}
