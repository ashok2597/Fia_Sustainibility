...
mix
  ...
  .sass(dir + '/src/styles/index.scss', dir + '/assets/styles/fiasustainability-core.css')
  .sourceMaps()
  .options(options)
  .polyfill({
    enabled: true,
...
mix.browserSync({
  proxy: 'https://fiasustainability.test',
  files: [
    dir + '/*.php',
    dir + '/partials/*.php',
    dir + '/style.css',
    dir + '/assets/styles/*.css',
    dir + '/assets/styles/fiasustainability-core.css',
